...
bool Player::Update(float dt)
{
	...
	if (App->input->GetMouseButtonDown(SDL_BUTTON_LEFT) == key_down && App->gui->GetMouseHover() == nullptr && App->input->GetKey(SDL_SCANCODE_X) != key_repeat && item_drop->MouseClickEnterLeft())
	{
		iPoint mouse;
