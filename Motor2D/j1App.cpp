...
bool j1App::Start()
{
	...
	debug_window = App->gui->UI_CreateWin(iPoint(0, 20), 200, 115, 1);
	debug_colored_rect = debug_window->CreateColoredRect(iPoint(0, 20), 200, 115, { 20, 20, 20, 125 }, true);
	debug_text = debug_window->CreateText(iPoint(5, 25), App->font->default_15, 15);
